...
export interface NexusGenObjects {
  ...
  Category: {
    ...
    categoryProducts?: Array<
      NexusGenRootTypes["CategoryProduct"] | null
    > | null; // [CategoryProduct]
    created_at: string; // String!
  ...
  GetAddressesResult: {
    ...
    deliveryAddresses?: Array<
      NexusGenRootTypes["DeliveryAddress"] | null
    > | null; // [DeliveryAddress]
    message: string; // String!
  };
  GetBrandProductsResult: {
    // root type
